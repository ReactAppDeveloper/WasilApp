...
const [showComponment7, setshowComponment7] = useState(true);
...
const [bgcolor7, setbgcolor7] = useState(Colors.primary);
...
const [textcolor7, settextcolor7] = useState(Colors.white);
