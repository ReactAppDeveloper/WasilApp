...
const TasbihEighteen = ({ navigation }) => {
...
const [showComponment17, setshowComponment17] = useState(true);
...
const [bgcolor17, setbgcolor17] = useState(Colors.primary);
...
const [textcolor17, settextcolor17] = useState(Colors.white);
