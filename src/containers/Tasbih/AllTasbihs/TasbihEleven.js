...
const [showComponment10, setshowComponment10] = useState(true);
...
const [bgcolor10, setbgcolor10] = useState(Colors.primary);
...
const [textcolor10, settextcolor10] = useState(Colors.white);
//1 to 10 names
