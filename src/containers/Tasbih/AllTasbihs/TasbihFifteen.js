...
const TasbihFifteen = ({ navigation }) => {
...
const [showComponment14, setshowComponment14] = useState(true);
...
const [bgcolor14, setbgcolor14] = useState(Colors.primary);
...
const [textcolor14, settextcolor14] = useState(Colors.white);
