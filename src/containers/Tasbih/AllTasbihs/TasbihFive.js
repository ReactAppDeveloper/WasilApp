...
const [showComponmentFthT, setshowComponmentFthT] = useState(true);
...
const [FthTbgcolor, setFthTbgcolor] = useState(Colors.primary);
...
const [Fthtextcolor, setFthtextcolor] = useState(Colors.white);
