...
const [showComponmentTT, setshowComponmentTT] = useState(true);
...
const [TTbgcolor, setTTbgcolor] = useState(Colors.primary);
...
const [TTtextcolor, setTTtextcolor] = useState(Colors.white);
