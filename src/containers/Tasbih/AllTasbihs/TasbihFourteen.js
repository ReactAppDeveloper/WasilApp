...
const TasbihFourteen = ({ navigation }) => {
...
const [showComponment13, setshowComponment13] = useState(true);
...
const [bgcolor13, setbgcolor13] = useState(Colors.primary);
...
const [textcolor13, settextcolor13] = useState(Colors.white);
