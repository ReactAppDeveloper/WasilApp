...
const [showComponment8, setshowComponment8] = useState(true);
...
const [bgcolor8, setbgcolor8] = useState(Colors.primary);
...
const [textcolor8, settextcolor8] = useState(Colors.white);
