...
const TasbihNinteen = ({ navigation }) => {
...
const [showComponment18, setshowComponment18] = useState(true);
...
const [bgcolor18, setbgcolor18] = useState(Colors.primary);
