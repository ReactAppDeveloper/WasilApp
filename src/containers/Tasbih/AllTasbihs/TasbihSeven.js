...
const [showComponmentSxT, setshowComponmentSxT] = useState(true);
...
const [SxTbgcolor, setSxTbgcolor] = useState(Colors.primary);
...
const [SxTtextcolor, setSxTtextcolor] = useState(Colors.white);
