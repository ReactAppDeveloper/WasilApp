...
const TasbihSeventeen = ({ navigation }) => {
...
const [showComponment16, setshowComponment16] = useState(true);
...
const [bgcolor16, setbgcolor16] = useState(Colors.primary);
...
const [textcolor16, settextcolor16] = useState(Colors.white);
...
export default TasbihSeventeen;