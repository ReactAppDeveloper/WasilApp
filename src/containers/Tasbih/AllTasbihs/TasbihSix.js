...
const [showComponmentFtT, setshowComponmentFtT] = useState(true);
...
const [FtTbgcolor, setFtTbgcolor] = useState(Colors.primary);
...
const [FtTtextcolor, setFtTtextcolor] = useState(Colors.white);
