...
const [showComponment9, setshowComponment9] = useState(true);
...
const [bgcolor9, setbgcolor9] = useState(Colors.primary);
...
const [textcolor9, settextcolor9] = useState(Colors.white);
