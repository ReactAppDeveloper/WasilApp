...
const TasbihThirteen = ({ navigation }) => {
...
const [showComponment12, setshowComponment12] = useState(true);
...
const [bgcolor12, setbgcolor12] = useState(Colors.primary);
...
const [textcolor12, settextcolor12] = useState(Colors.white);
