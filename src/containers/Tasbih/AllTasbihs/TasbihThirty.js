...
const [showComponment29, setshowComponment29] = useState(true);
...
const [bgcolor29, setbgcolor29] = useState(Colors.primary);
...
const [textcolor29, settextcolor29] = useState(Colors.white);
