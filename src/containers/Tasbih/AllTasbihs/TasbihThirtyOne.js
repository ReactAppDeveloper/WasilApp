...
const TasbihThirtyOne = ({ navigation }) => {
...
const [showComponment30, setshowComponment30] = useState(true);
...
const [bgcolor30, setbgcolor30] = useState(Colors.primary);
...
const [textcolor30, settextcolor30] = useState(Colors.white);
...
export default TasbihThirtyOne;