...
const TasbihThirtyTwo = ({ navigation }) => {
...
const [showComponment31, setshowComponment31] = useState(true);
...
const [bgcolor31, setbgcolor31] = useState(Colors.primary);
...
const [textcolor31, settextcolor31] = useState(Colors.white);
//21 to 31 names
...
export default TasbihThirtyTwo;