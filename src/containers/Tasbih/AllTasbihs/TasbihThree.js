...
const [showComponmentST, setshowComponmentST] = useState(true);
...
const [STbgcolor, setSTbgcolor] = useState(Colors.primary);
...
const [STtextcolor, setSTtextcolor] = useState(Colors.white);
