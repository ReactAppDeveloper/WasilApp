...
//11 to 20 names
const [showComponment11, setshowComponment11] = useState(true);
...
const [bgcolor11, setbgcolor11] = useState(Colors.primary);
...
const [textcolor11, settextcolor11] = useState(Colors.white);
