...
const [showComponment19, setshowComponment19] = useState(true);
...
const [bgcolor19, setbgcolor19] = useState(Colors.primary);
...
const [textcolor19, settextcolor19] = useState(Colors.white);
