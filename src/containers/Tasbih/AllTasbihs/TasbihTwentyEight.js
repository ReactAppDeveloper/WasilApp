...
const TasbihTwentyEight = ({ navigation }) => {
...
const [showComponment15, setshowComponment15] = useState(false);
...
const [bgcolor15, setbgcolor15] = useState(Colors.tasbihitembg);
...
const [textcolor15, settextcolor15] = useState(Colors.intermediate);
...
const [showComponment27, setshowComponment27] = useState(true);
...
const [bgcolor27, setbgcolor27] = useState(Colors.primary);
...
const [textcolor27, settextcolor27] = useState(Colors.white);
...
export default TasbihTwentyEight;