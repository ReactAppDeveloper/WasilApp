...
const TasbihTwentyFive = ({ navigation }) => {
...
const [showComponment24, setshowComponment24] = useState(true);
...
const [bgcolor24, setbgcolor24] = useState(Colors.primary);
...
const [textcolor24, settextcolor24] = useState(Colors.white);
...
export default TasbihTwentyFive;