...
const TasbihTwentyFour = ({ navigation }) => {
...
const [showComponment23, setshowComponment23] = useState(true);
...
const [bgcolor23, setbgcolor23] = useState(Colors.primary);
...
const [textcolor23, settextcolor23] = useState(Colors.white);
...
export default TasbihTwentyFour;