...
const TasbihTwentyNine = ({ navigation }) => {
...
const [showComponment28, setshowComponment28] = useState(true);
...
const [bgcolor28, setbgcolor28] = useState(Colors.primary);
...
const [textcolor28, settextcolor28] = useState(Colors.white);
...
export default TasbihTwentyNine;