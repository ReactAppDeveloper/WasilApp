...
const TasbihTwentyOne = ({ navigation }) => {
...
const [showComponment20, setshowComponment20] = useState(true);
...
const [bgcolor20, setbgcolor20] = useState(Colors.primary);
...
const [textcolor20, settextcolor20] = useState(Colors.white);
//11 to 20 names
...
export default TasbihTwentyOne;