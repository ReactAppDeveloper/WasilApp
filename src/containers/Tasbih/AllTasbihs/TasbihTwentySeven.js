...
const TasbihTwentySeven = ({ navigation }) => {
...
const [showComponment26, setshowComponment26] = useState(true);
...
const [bgcolor26, setbgcolor26] = useState(Colors.primary);
...
const [textcolor26, settextcolor26] = useState(Colors.white);
...
export default TasbihTwentySeven;