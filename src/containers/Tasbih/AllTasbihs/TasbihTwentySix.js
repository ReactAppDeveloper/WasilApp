...
const TasbihTwentySix = ({ navigation }) => {
...
const [showComponment25, setshowComponment25] = useState(true);
...
const [bgcolor25, setbgcolor25] = useState(Colors.primary);
...
const [textcolor25, settextcolor25] = useState(Colors.white);
...
export default TasbihTwentySix;