...
const TasbihTwentyThree = ({ navigation }) => {
...
const [showComponment22, setshowComponment22] = useState(true);
...
const [bgcolor22, setbgcolor22] = useState(Colors.primary);
...
const [textcolor22, settextcolor22] = useState(Colors.white);
...
export default TasbihTwentyThree;