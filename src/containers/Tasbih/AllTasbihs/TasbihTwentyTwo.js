...
const TasbihTwentyTwo = ({ navigation }) => {
...
//21 to 31 names
const [showComponment21, setshowComponment21] = useState(true);
...
const [bgcolor21, setbgcolor21] = useState(Colors.primary);
...
const [textcolor21, settextcolor21] = useState(Colors.white);
...
export default TasbihTwentyTwo;