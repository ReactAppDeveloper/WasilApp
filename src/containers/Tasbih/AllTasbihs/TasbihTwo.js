...
//1 to 10 names
const [showComponmentFT, setshowComponmentFT] = useState(true);
...
const [FTbgcolor, setFTbgcolor] = useState(Colors.primary);
...
const [FTtextcolor, setFTtextcolor] = useState(Colors.white);
